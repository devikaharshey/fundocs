  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-muted px-6">
      ...
      >
        {status === "pending" && (
          <div>
            <p className="text-lg font-medium text-white mb-2">📩 Check your inbox</p>
            <p className="text-muted-foreground">
              Please verify your email address using the link sent to your email.
            </p>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-medium text-green-500">Your email has been verified!</p>
        ...
        {status === "error" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-medium text-red-500">Verification failed</p>
            <p className="text-muted-foreground">The link may have expired or is invalid. Please request a new one.</p>
          </div>
        )}
      </motion.div>
    </div>
